...
public class ControllerHandler extends XMLParser {
	...
	private void fetchControllersList() throws IllegalInjectionNumberException {
		...
		try {
			...
			for (int c = 0; c < nodelist.getLength(); c++) {
				...
				if (elem.getNodeType() == Node.ELEMENT_NODE) {
					...
					controller.setActions(ActionHandler.getActionList(cobject,controller));
					...
					if (cobject.getClass().isAnnotationPresent(
						...
						clayout.setBlocs(LayoutHandler.getInstance()
								.getLayoutBlocs(
										FileUtils.getFileContent(clayout
												.getFilePath())));
	...
	public List<Controller> getControllersList()
			throws IllegalInjectionNumberException {
